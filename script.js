document.addEventListener('DOMContentLoaded', () => {
    ...
    const lyrics = [
        { time: 0, text: "....." },
        { time: 3, text: "I'll be here waiting you to come" },
        { time: 6, text: "And bring me right back home" },
        { time: 9, text: "I'm caught up with these memories" },
        { time: 16, text: "Just by sitting here alone" },
        { time: 20, text: "If only I could see where it all started, we'll be fine" },
        { time: 23, text: "It's clear where this is goin'" },
        { time: 30, text: "I'll keep missing you alone" },
        { time: 33, text: "If you could see me cryin' in my room" },
        { time: 37, text: "Hey, I missed you too" },
        { time: 44, text: "And just so you know, I still love you" },
    ];
